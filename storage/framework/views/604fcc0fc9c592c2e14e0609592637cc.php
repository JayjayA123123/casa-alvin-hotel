...
<?php $__env->startSection('hero'); ?>
    ...
    <div class="search-bar">
        <form action="<?php echo e(route('rooms.index')); ?>" method="GET" class="row g-3 align-items-end">
            <div class="col-md-3">
                <label>Check-in</label>
                <input type="date" name="check_in" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>">
            </div>
            <div class="col-md-3">
                <label>Check-out</label>
                <input type="date" name="check_out" class="form-control" value="<?php echo e(now()->addDays(2)->format('Y-m-d')); ?>">
            </div>
            <div class="col-md-3">
                <label>Guests</label>
...
<?php $__env->startSection('content'); ?>
    <div class="pt-5 mt-4">
        <div class="d-flex justify-content-between align-items-end mb-4 reveal">
            ...
            <a href="<?php echo e(route('rooms.index')); ?>" class="btn btn-outline-navy btn-sm">View All Rooms</a>
        </div>
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-6 col-lg-3">
                    <div class="room-card panel shadow-card reveal reveal-<?php echo e(($i % 4) + 1); ?>">
                        <?php $img = $room->image ? Storage::url($room->image) : $stockPhotos[$i % count($stockPhotos)]; ?>
                        <img src="<?php echo e($img); ?>" class="room-card__img" alt="<?php echo e($room->room_type); ?>">
                        <div class="room-card__body">
                            <div class="room-card__title"><?php echo e($room->room_type); ?></div>
                            ...
                            <div class="room-card__facts">
                                ...
                                <span><i class="bi bi-door-closed"></i> Room <?php echo e($room->room_number); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="room-card__price">&#8369;<?php echo e(number_format($room->price_per_night, 0)); ?><small> / night</small></div>
                                <a href="<?php echo e(route('bookings.create')); ?>?room=<?php echo e($room->id); ?>" class="btn btn-orange btn-sm">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php if(auth()->guard()->guest()): ?>
        <div class="panel shadow-card text-center py-5 px-3 mb-4 reveal">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn btn-orange me-2">Create an Account</a>
            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-navy">Log In</a>
        </div>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.booking', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\alvinjay\resources\views/welcome.blade.php ENDPATH**/ ?>