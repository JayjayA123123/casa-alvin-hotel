...
<head>
    ...
    <title>@yield('title', 'StayPinas') - {{ config('app.name', 'StayPinas') }}</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navMain">
                ...
                <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <div class="dropdown me-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                @if (auth()->user()->isAdmin())
                                    <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i class="bi bi-speedometer2 me-1"></i>Admin Dashboard</a></li>
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-hotel-outline btn-sm me-2">Login</a>
                        <a href="{{ route('register') }}" class="btn btn-orange btn-sm">Register</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <div class="container pb-5 @hasSection('hero') pt-0 @else pt-4 @endif">
        @if (session('success'))
    ...
    @unless (request()->routeIs('dashboard') || request()->routeIs('rooms.create') || request()->routeIs('rooms.edit'))
        <footer class="site-footer">
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6">
                        <a class="navbar-brand mb-2 d-inline-flex" href="{{ url('/') }}">
                            <span class="brand-mark"><img src="{{ asset('images/staypinas-mark.svg') }}" alt="StayPinas" style="width:100%;height:100%;object-fit:contain;"></span>
                            StayPinas
                        </a>
                ...
                <div class="footer-bottom">&copy; {{ date('Y') }} StayPinas. All rights reserved.</div>
            </div>
        </footer>
    @endunless
