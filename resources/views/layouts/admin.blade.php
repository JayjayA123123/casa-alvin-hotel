...
<head>
    ...
    <title>@yield('title', 'Admin') - {{ config('app.name', 'StayPinas') }}</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .badge-role-customer { background: var(--bg); color: var(--text-muted); border: 1px solid var(--line); }
        ...
        .form-control, .form-select { border: 1px solid var(--line); border-radius: 9px; padding: .5rem .7rem; font-size: .88rem; }
        ...
        .admin-sidebar .nav-section-label {
            font-size: .68rem; text-transform: uppercase; letter-spacing: .06em; color: rgba(255,255,255,.35);
    ...
    <div class="admin-shell">
        <aside class="admin-sidebar">
            ...
            <a href="{{ route('rooms.index') }}" class="nav-link {{ request()->routeIs('rooms.*') ? 'active' : '' }}">
                <i class="bi bi-door-closed-fill"></i> Rooms
            </a>
